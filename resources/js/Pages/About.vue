	...
	<div class="space-y-20 px-12">
		...
		<div class="flex justify-center">
			<div class="grid grid-cols-3 gap-2">
				<div class="border border-gray-500 p-1" v-for="i in 3" :key="i">
					<img class="h-[350px] w-auto border" src="https://media.istockphoto.com/photos/black-and-white-portrait-of-fashion-blond-woman-with-short-hair-picture-id960471134?k=20&m=960471134&s=612x612&w=0&h=hmf2Ywv_ALLRxur6AEvaZE5Bw-5hj7pdtk5u7hv_gWc=">
					<div class="max-w-md space-y-2">
						<p>Naz</p>
						<p>Addis Ababa</p>
						<p class="text-gray-400 text-sm">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo

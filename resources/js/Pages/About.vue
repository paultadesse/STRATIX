			...
			<div class="grid grid-cols-3 gap-2">
				<div class="shadow p-4" v-for="i in 5" :key="i">
					...
					<div class="max-w-md space-y-2 mt-4">
						...
						<p>Addis Ababa</p>
						<p class="text-gray-500 italic text-sm tracking-wider font-light">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod
						tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam,
						quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo
						consequat. Duis aute irure dolor in reprehenderit in voluptate velit.</p>
						<hr class="w-1/6 border border-gray-100">
						<div class="flex space-x-2">
							<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" class="opacity-50">
							    <g>
							...
							<svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px" viewBox="0 0 24 24" class="opacity-50" fill="none">

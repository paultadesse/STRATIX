	...
	<div class="px-6 xl:px-12">
		<div class="grid xl:grid-cols-2 py-16 xl:py-36 xl:place-items-center  xl:px-24 shadow-sm">
			<div class="max-w-2xl py-7 xl:py-0 xl:border-r-2">
				<p class="text-5xl xl:text-7xl font-extrabold font-roboto">Let's create progress together.</p>
			</div>
			<div class="max-w-2xl py-7 xl:py-0 flex items-center space-x-2">
				<svg xmlns="http://www.w3.org/2000/svg" class="h-7 w-7" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
				  <path stroke-linecap="round" stroke-linejoin="round" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
				</svg>
				<a href="mailto:info@stratixstudio.com" class="xl:text-3xl font-bold tracking-wide">info@stratixstudio.com</a>
			</div>
			<!-- form -->
		...
		<div class="shadow-2xl xl:p-4">
			<p class="xl:text-2xl uppercase font-bold tracking-wider">Stratix Office - 5th floor </p>
